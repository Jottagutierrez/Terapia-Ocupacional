...
num_est = dbr.F_translate_into_week(xl_sheet).num_est
...
print(DATA_matrix_Act[396])
print(DATA_matrix_Act[397])
print(DATA_matrix_Act[398])
print(DATA_matrix_Act[399])

print('Linea 177:')
print(DATA_list_Lin[177])
print('Linea 176:')
print(DATA_list_Lin[176])
